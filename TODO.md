...
- [ ] Add Sentry bootstrap (client/server) helpers  
...
- [ ] Replace placeholder Toaster with real toast system  
...
- [ ] Mutation error adapter for Convex calls  
...
- [ ] Wire order submit flow to adapter + toast  
