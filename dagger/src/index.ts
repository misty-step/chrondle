  ...
  private docsLinkCheckContainer(source: Directory): Container {
    return dag
      ...
      .withExec([
        "sh",
        "-lc",
        "find . -name '*.md' ! -path './.backlog.d/*' ! -path './docs/archive/reports/*' ! -path './docs/specs/*' ! -path './dagger/node_modules/*' -print0 | xargs -0 -r lychee --offline --no-progress --root-dir /work --exclude '^/Users/'",
      ]);
  }
