...
const DISTANCE_COLORS: DistanceColor[] = [
  {
    ...
    fillColor: "var(--distance-perfect)",
    label: "Perfect!",
  },
  {
    threshold: 5,
    colorClass: "distance-close",
    fillColor: "var(--distance-close)",
    label: "Very close",
  },
  {
    threshold: 25,
    colorClass: "distance-near",
    fillColor: "var(--distance-near)",
    label: "Close",
  },
  {
    threshold: 50,
    colorClass: "distance-far",
    fillColor: "var(--distance-far)",
    label: "Somewhat far",
  },
  {
    threshold: 100,
    colorClass: "distance-very-far",
    fillColor: "var(--distance-very-far)",
    label: "Far",
  },
  {
    threshold: 500,
    colorClass: "distance-way-off",
    fillColor: "var(--distance-way-off)",
    label: "Very far",
  },
  {
    threshold: Infinity,
    colorClass: "distance-extreme",
    fillColor: "var(--distance-extreme)",
    label: "Extremely far",
  },
];
