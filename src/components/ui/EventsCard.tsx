...
export const EventsCard: React.FC<EventsCardProps> = ({ events, targetYear }) => {
  return (
    <div className="from-card via-card to-muted/50 border-border/50 rounded-2xl border bg-gradient-to-br p-4 shadow-lg">
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          {events.map((event, index) => (
            <div
              key={index}
              className="group bg-background/60 border-border/30 hover:bg-background/80 rounded-lg border p-4 transition-all duration-200 hover:shadow-md"
            >
