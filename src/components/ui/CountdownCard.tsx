...
export const CountdownCard: React.FC<CountdownCardProps> = ({ timeString }) => {
  return (
    <div className="from-primary/10 dark:from-primary/5 border-primary/20 rounded-2xl border bg-gradient-to-br via-blue-50/50 to-purple-50/50 p-4 shadow-lg dark:via-blue-950/20 dark:to-purple-950/20">
      <div className="space-y-2 text-center">
        ...
        {/* Countdown */}
        <div className="bg-background/60 border-border/30 rounded-xl border p-4">
