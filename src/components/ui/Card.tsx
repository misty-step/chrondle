...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "material-card text-card-foreground shadow-hard hover:shadow-hard-lg flex flex-col gap-6 rounded-xl p-6 transition-all duration-300",
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-ink-900 font-serif text-2xl leading-none font-semibold tracking-tight",
        className,
      )}
      {...props}
    />
