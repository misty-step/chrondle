...
export function ScoreDisplay({ width, hintsUsed, variant = "full", className }: ScoreDisplayProps) {
  ...
  if (variant === "compact") {
    return (
      <div
        className={cn(
          "flex flex-col items-center gap-2 rounded border-2 px-5 py-3 shadow-md transition-all sm:px-6 sm:py-4",
          isValid
  ...
  return (
    <div
      className={cn(
        "rounded border-3 p-8 text-center shadow-lg transition-all",
        isValid
          ? "border-primary/50 from-primary/10 to-primary/5 shadow-primary/20 bg-gradient-to-br"
          : "border-muted bg-muted/30",
        className,
