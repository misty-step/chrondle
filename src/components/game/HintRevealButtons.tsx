...
export function HintRevealButtons({
  ...
  return (
    <div className={cn("space-y-5", className)}>
      ...
      <div className="border-primary bg-primary/10 rounded border-2 p-5 shadow-md sm:p-6">
      ...
      {revealedClues.length > 0 && (
        <div className="space-y-3">
          {revealedClues.map((clue, index) => (
            <div
              key={index}
              className="border-primary/40 bg-primary/5 rounded border p-4 shadow-sm"
            >
      ...
      {hasMoreClues && (
        <div className="rounded border-2 border-amber-500/30 bg-amber-500/5 p-5 shadow-lg">
